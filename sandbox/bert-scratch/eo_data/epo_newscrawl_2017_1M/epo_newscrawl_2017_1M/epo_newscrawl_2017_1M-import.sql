CREATE DATABASE `epo_newscrawl_2017_1M`;

USE epo_newscrawl_2017_1M;
...
CREATE TABLE `words` (
  ...
  KEY `word` (`word`),
  KEY `w_id` (`w_id`)
) ENGINE=MyISAM AUTO_INCREMENT=973925 DEFAULT CHARSET=utf8;
...
CREATE TABLE `sources` (
  ...
  KEY `so_id` (`so_id`),
  KEY `date` (`date`)
) ENGINE=MyISAM AUTO_INCREMENT=53982 DEFAULT CHARSET=utf8;
...
LOAD DATA LOCAL INFILE 'epo_newscrawl_2017_1M-words.txt' INTO TABLE words;
LOAD DATA LOCAL INFILE 'epo_newscrawl_2017_1M-sentences.txt' INTO TABLE sentences;
LOAD DATA LOCAL INFILE 'epo_newscrawl_2017_1M-co_s.txt' INTO TABLE co_s;
LOAD DATA LOCAL INFILE 'epo_newscrawl_2017_1M-co_n.txt' INTO TABLE co_n;
LOAD DATA LOCAL INFILE 'epo_newscrawl_2017_1M-inv_w.txt' INTO TABLE inv_w;
LOAD DATA LOCAL INFILE 'epo_newscrawl_2017_1M-inv_so.txt' INTO TABLE inv_so;
LOAD DATA LOCAL INFILE 'epo_newscrawl_2017_1M-sources.txt' INTO TABLE sources;
