CREATE DATABASE `epo_wikipedia_2016_300K`;

USE epo_wikipedia_2016_300K;
...
CREATE TABLE `words` (
  ...
  KEY `word` (`word`),
  KEY `w_id` (`w_id`)
) ENGINE=MyISAM AUTO_INCREMENT=426042 DEFAULT CHARSET=utf8;

CREATE TABLE `sentences` (
  `s_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `sentence` text,
  KEY `s_id` (`s_id`)
) ENGINE=MyISAM AUTO_INCREMENT=300001 DEFAULT CHARSET=utf8;
...
CREATE TABLE `sources` (
  ...
  KEY `so_id` (`so_id`),
  KEY `date` (`date`)
) ENGINE=MyISAM AUTO_INCREMENT=97699 DEFAULT CHARSET=utf8;
...
LOAD DATA LOCAL INFILE 'epo_wikipedia_2016_300K-words.txt' INTO TABLE words;
LOAD DATA LOCAL INFILE 'epo_wikipedia_2016_300K-sentences.txt' INTO TABLE sentences;
LOAD DATA LOCAL INFILE 'epo_wikipedia_2016_300K-co_s.txt' INTO TABLE co_s;
LOAD DATA LOCAL INFILE 'epo_wikipedia_2016_300K-co_n.txt' INTO TABLE co_n;
LOAD DATA LOCAL INFILE 'epo_wikipedia_2016_300K-inv_w.txt' INTO TABLE inv_w;
LOAD DATA LOCAL INFILE 'epo_wikipedia_2016_300K-inv_so.txt' INTO TABLE inv_so;
LOAD DATA LOCAL INFILE 'epo_wikipedia_2016_300K-sources.txt' INTO TABLE sources;
