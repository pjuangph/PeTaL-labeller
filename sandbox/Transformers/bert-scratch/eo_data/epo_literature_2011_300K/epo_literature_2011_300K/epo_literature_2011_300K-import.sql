CREATE DATABASE `epo_literature_2011_300K`;

USE epo_literature_2011_300K;
...
CREATE TABLE `words` (
  ...
  KEY `word` (`word`),
  KEY `w_id` (`w_id`)
) ENGINE=MyISAM AUTO_INCREMENT=213097 DEFAULT CHARSET=utf8;
...
LOAD DATA LOCAL INFILE 'epo_literature_2011_300K-words.txt' INTO TABLE words;
LOAD DATA LOCAL INFILE 'epo_literature_2011_300K-sentences.txt' INTO TABLE sentences;
LOAD DATA LOCAL INFILE 'epo_literature_2011_300K-co_s.txt' INTO TABLE co_s;
LOAD DATA LOCAL INFILE 'epo_literature_2011_300K-co_n.txt' INTO TABLE co_n;
LOAD DATA LOCAL INFILE 'epo_literature_2011_300K-inv_w.txt' INTO TABLE inv_w;
LOAD DATA LOCAL INFILE 'epo_literature_2011_300K-inv_so.txt' INTO TABLE inv_so;
LOAD DATA LOCAL INFILE 'epo_literature_2011_300K-sources.txt' INTO TABLE sources;
